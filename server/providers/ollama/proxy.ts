...
export const createProxiedFetch = () => {
  ...
  function proxiedFetch(url: string | URL | Request, init?: RequestInit): Promise<Response>;
  async function proxiedFetch(urlOrRequest: Request | string | URL, init?: RequestInit): Promise<Response> {
    const id = uuid4();
